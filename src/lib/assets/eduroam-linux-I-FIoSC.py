...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "IFSC - Federal Institute of Santa Catarina"
Config.profilename = "IFSC"
Config.url = "http://dtic.ifsc.edu.br/servicos-de-tic/redesemfio/"
Config.email = "suporte.ti@ifsc.edu.br"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.ifsc.edu.br"
...
Config.user_realm = "ifsc.edu.br"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduroam.ifsc.edu.br']
